...
public class FastThreadLocal<V> {
    ...
    public static void removeAll() {
        ...
        try {
            ...
            // 如果此位置的值被覆盖过 不是  InternalThreadLocalMap.UNSET
    ...
    @SuppressWarnings("unchecked")
    /**
     * 将FastThreadLocal 放到 variablesToRemoveIndex 存储
     */
    private static void addToVariablesToRemove(InternalThreadLocalMap threadLocalMap, FastThreadLocal<?> variable) {
        Object v = threadLocalMap.indexedVariable(variablesToRemoveIndex);

        // 初始化数据结构  Set<FastThreadLocal<?>>
        Set<FastThreadLocal<?>> variablesToRemove;
        if (v == InternalThreadLocalMap.UNSET || v == null) {
            // IdentityHashMap 底层也是数组 key,value 在map中挨着存储.利用key的hash值确定存储的索引位置
    ...
    private static void removeFromVariablesToRemove(
        ...
        // 从  UnpaddedInternalThreadLocalMap #  Object[] indexedVariables  中移除元素
        Object v = threadLocalMap.indexedVariable(variablesToRemoveIndex);
